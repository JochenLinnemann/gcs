...
public class ItemMenuProvider {
    ...
    public static JMenu createMenu() {
        ...
        menu.add(MenuHelpers.createSubMenu(I18n.Text("Spells"), NewSpellCommand.INSTANCE, NewSpellCommand.CONTAINER_INSTANCE, null, NewSpellCommand.RITUAL_MAGIC_INSTANCE, NewSpellCommand.SPLITTERMOND_INSTANCE));
